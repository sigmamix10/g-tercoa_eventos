    ...
    try {
      ...
      await mysqlPool.query(`
        CREATE TABLE IF NOT EXISTS users (
          ...
          role VARCHAR(50) CHECK(role IN ('admin', 'moderator', 'evaluator', 'participant')) NOT NULL,
          photo_url TEXT,
          minibio TEXT,
          contact VARCHAR(100),
      ...
      await mysqlPool.query(`
        CREATE TABLE IF NOT EXISTS events (
          ...
          name VARCHAR(255) NOT NULL,
          type VARCHAR(50) CHECK(type IN ('school_of_summer', 'dima', 'live_cycle', 'workshop')) NOT NULL,
          description TEXT,
          banner_url TEXT,
      ...
      await mysqlPool.query(`
        CREATE TABLE IF NOT EXISTS activities (
          ...
          type VARCHAR(50) CHECK(type IN ('palestra', 'mesa_redonda', 'minicurso', 'outro')) NOT NULL,
      ...
      await mysqlPool.query(`
        CREATE TABLE IF NOT EXISTS submissions (
          ...
          status VARCHAR(50) CHECK(status IN ('under_review', 'accepted', 'accepted_with_remarks', 'rejected')) DEFAULT 'under_review',
      ...
      await mysqlPool.query(`
        CREATE TABLE IF NOT EXISTS event_assignments (
          ...
          event_id VARCHAR(255) NOT NULL,
          user_id VARCHAR(255) NOT NULL,
          role VARCHAR(50) CHECK(role IN ('coordinator', 'evaluator', 'organizer', 'event_coordinator')) NOT NULL,
          axis VARCHAR(255),
          FOREIGN KEY (event_id) REFERENCES events (id) ON DELETE CASCADE,
          FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE,
